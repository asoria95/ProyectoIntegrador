...
class c_validar{
    ...
    //Atributos
    private $persona= array($_REQUEST[txtcedula],$_REQUEST[txtnombre], $_REQUEST[txtapellidos],$_REQUEST[datfecha],$_REQUEST[txttelefono], $_REQUEST[lissexo], $_REQUEST[lisgenero],$_REQUEST[txtdireccion],$_REQUEST[txtcorreo]);
    
    
    $cedula = str_split($_REQUEST[txtcedula]);
